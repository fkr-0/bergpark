...
class CompositionTests(unittest.TestCase):
    ...
    def test_composed_spatial_layers_match_independent_producers_exactly(self):
        ...
        self.assertEqual(topology["path_node_count"], len(graph["path_nodes"]))
        self.assertEqual(topology["directed_segment_count"], len(graph["path_segments"]))
        self.assertGreater(len(graph["path_nodes"]), 1408)
        self.assertGreater(len(graph["path_segments"]), 2858)
